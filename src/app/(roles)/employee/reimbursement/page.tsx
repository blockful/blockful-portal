    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/20 transition-all duration-300">
          ...
          {status === 'loading' && (
            <div className="mx-6 mt-4 p-4 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 flex items-center space-x-2">
          ...
          {status === 'unauthenticated' && (
            <div className="mx-6 mt-4 p-4 rounded-md bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-200 flex items-center space-x-2">
              <AlertCircle className="h-5 w-5" />
              <span className="text-sm font-medium">Please log in to submit reimbursement requests</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <button
                type="submit"
                disabled={isSubmitting || status === 'loading' || !selectedFile}
              ...
              >
                {isSubmitting ? "Submitting..." : status === 'loading' ? "Loading..." : "Submit Request"}
              </button>
            </div>
          </form>
        </div>
